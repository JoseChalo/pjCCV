            ...
            <form class="row g-3" method="post" action="editar_evento.php">
                <div class="col-md-6">
                    ...
                    <input type="text" maxlength="90" class="form-control"
                        placeholder="Titulo (Maximo de caracteres 90)" name="title" autocomplete="off" required
                        value="<?php echo htmlspecialchars($tituloActual); ?>">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="time" class="form-control" placeholder="hour" name="hour" required
                        value="<?php echo htmlspecialchars($horaActual); ?>">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" placeholder="Texto requerido" name="descrip" autocomplete="off"
                        required><?php echo htmlspecialchars($descripcionActual); ?></textarea>
                </div>
                <div class="col-12">
                    <input type="hidden" name="idEvento" value="<?php echo htmlspecialchars($idEvento); ?>">
                    <button type="submit" class="btn btn-primary" name="btnregistroevento" value="ok">Modificar
                        Evento</button>
                </div>
            </form>
        </div>
